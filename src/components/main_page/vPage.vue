<template>
  ...
  <div class="container-album">
    <div class="content" v-for="album in albums" :key="album.id">
      <div class="content-wrapper">
        <div class="img_2">
                   <img :src="require(`/src/assets/img/${album.img}`)">
        </div>
        <div class="text_2">
          ...
          <div class="start-wrapper">
            <div class="flex-start">
              <div class="player-controls__item -xl js-play btn_2" @click="play">
                ...
                <i class="fa-solid fa-pause color_black" v-if="show_2"></i>
              </div>
            ...
            <div class="box">
              <div class="reset" @click="reset">
                <div class="power-switch">
                  <input type="checkbox" class="checkbox" v-if="checkbox"/>
                  <div class="button">
                    <svg class="power-off">
  ...
  <div class="wrapper" id="app">
    <div class="content__2">
      <div class="start">
        <div class="img">
          <img :src="require('/src/assets/img/khalib.jpg')" alt="vue-logo">
        </div>
        <div class="text">
          <h1>{{ name }}</h1>
          <p>{{ first_name }}</p>
      ...
      <div class="center">
        <div class="icons">
          ...
          <div class="player-controls__item -xl js-play btn_2" @click="play">
            <i class="play_2 fa-solid fa-play" v-if="inshow"></i>
            <i class="fa-solid fa-pause color_black" v-if="show"></i>
          </div>
          <div class="next">
...
export default {
  ...
  mounted() {
    ...
    let fa_play = document.querySelector('.player-controls__item')
    let power_on = document.querySelector('.power-switch .button .power-on')
    fa_play.addEventListener('click', () => {
      power_on.classList.toggle('dn')
    })
  },
  computed: {
    filteredPosts() {
